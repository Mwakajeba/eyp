...
return new class extends Migration
{
    ...
    {
        Schema::create('investment_proposal_approval_settings', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('company_id');
            $table->integer('approval_levels')->default(3);
            $table->decimal('auto_approval_limit', 15, 2)->nullable(); // Proposals below this amount may not need approval
    ...
    {
        Schema::dropIfExists('investment_proposal_approval_settings');
    }
};

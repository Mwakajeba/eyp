    ...
    public function run()
    {
        ...
        $entities = [
            ...
            'Rental & Event Equipment' => [
                'icon' => 'bx bx-package',
                'visibleRoutes' => [
                    ['name' => 'Rental & Event Equipment', 'route' => 'rental-event-equipment.index'],
                    ['name' => 'Equipment Master', 'route' => 'rental-event-equipment.equipment.index'],
                    ['name' => 'Customer Deposits', 'route' => 'cash_collaterals.index'],
                    ['name' => 'Create Customer Deposit', 'route' => 'cash_collaterals.create'],
                    ['name' => 'Accounting Settings', 'route' => 'rental-event-equipment.accounting-settings.index'],
                    ['name' => 'Rental Inventory Settings', 'route' => 'rental-event-equipment.rental-inventory-settings.index'],
                ],
                'hiddenRoutes' => [
                    // Equipment
                    'rental-event-equipment.equipment.data',
                    'rental-event-equipment.equipment.create',
                    'rental-event-equipment.equipment.store',
                    'rental-event-equipment.equipment.show',
                    'rental-event-equipment.equipment.edit',
                    'rental-event-equipment.equipment.update',
                    'rental-event-equipment.equipment.destroy',

                    // Categories
                    'rental-event-equipment.categories.data',
                    'rental-event-equipment.categories.check-name',
                    'rental-event-equipment.categories.create',
                    'rental-event-equipment.categories.store',
                    'rental-event-equipment.categories.show',
                    'rental-event-equipment.categories.edit',
                    'rental-event-equipment.categories.update',
                    'rental-event-equipment.categories.destroy',

                    // Quotations / contracts / dispatch / returns / invoices / deposits
                    'rental-event-equipment.quotations.data',
                    'rental-event-equipment.quotations.create',
                    'rental-event-equipment.quotations.store',
                    'rental-event-equipment.quotations.show',
                    'rental-event-equipment.quotations.edit',
                    'rental-event-equipment.quotations.update',
                    'rental-event-equipment.quotations.submit-for-approval',
                    'rental-event-equipment.quotations.destroy',
                    'rental-event-equipment.quotations.export-pdf',

                    'rental-event-equipment.contracts.data',
                    'rental-event-equipment.contracts.create',
                    'rental-event-equipment.contracts.create.from-quotation',
                    'rental-event-equipment.contracts.store',
                    'rental-event-equipment.contracts.show',
                    'rental-event-equipment.contracts.edit',
                    'rental-event-equipment.contracts.update',
                    'rental-event-equipment.contracts.destroy',
                    'rental-event-equipment.contracts.export-pdf',

                    'rental-event-equipment.rental-dispatches.data',
                    'rental-event-equipment.rental-dispatches.create',
                    'rental-event-equipment.rental-dispatches.store',
                    'rental-event-equipment.rental-dispatches.items',
                    'rental-event-equipment.rental-dispatches.show',
                    'rental-event-equipment.rental-dispatches.confirm-dispatch',

                    'rental-event-equipment.rental-returns.data',
                    'rental-event-equipment.rental-returns.create',
                    'rental-event-equipment.rental-returns.store',
                    'rental-event-equipment.rental-returns.show',
                    'rental-event-equipment.rental-returns.destroy',

                    'rental-event-equipment.customer-deposits.data',
                    'rental-event-equipment.customer-deposits.store',
                    'rental-event-equipment.customer-deposits.get-contracts',
                    'rental-event-equipment.customer-deposits.customer-detail',
                    'rental-event-equipment.customer-deposits.export-customer-pdf',
                    'rental-event-equipment.customer-deposits.show',
                    'rental-event-equipment.customer-deposits.edit',
                    'rental-event-equipment.customer-deposits.update',
                    'rental-event-equipment.customer-deposits.destroy',
                    'rental-event-equipment.customer-deposits.export-pdf',
                ],
            ],
            'Accounting' => [
            ...
            'Fleet Management' => [
                'icon' => 'bx bx-car',
                'visibleRoutes' => [
                    ['name' => 'Fleet Management', 'route' => 'fleet.index'],
                ],
                'hiddenRoutes' => [
                    ...
                    'fleet.vehicles.sample.download',
                ],
            ],
            'Loans Payable' => [
                'icon' => 'bx bx-money',

            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-primary text-white">
                                ...
                                {{ __('app.edit_budget') }} {{ __('app.info') }}
                        </h5>
                    </div>
                    <div class="card-body">
                        <form id="budgetForm" action="{{ route('accounting.budgets.update', $budget) }}" method="POST">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                               name="name" value="{{ old('name', $budget->name) }}" required>
                                        @error('name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                                  name="description" rows="3" 
                                                                                                     placeholder="Weka maelezo ya bajeti (si lazima)">{{ old('description', $budget->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
...
.budget-line-item .card-header .btn-outline-danger {
    font-size: 0.75rem;

...
@section('title', 'Fleet Approval Settings')
...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h5 class="mb-0 text-primary">Fleet Approval Settings</h5>
                <small class="text-muted">Configure multi-level approval workflow for fleet operations</small>
            </div>
            <div>
                <a href="{{ route('fleet.settings.index') }}" class="btn btn-secondary">
        ...
        <div class="alert alert-info border-0">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h6 class="mb-1">Fleet Approval Workflow</h6>
                    <p class="mb-0"><strong>When enabled:</strong> New fleet operations (trips, invoices, costs) are set to <strong>Pending for approval</strong>. Approvers must approve before actions are available. Rejected operations can be edited and resubmitted for approval.</p>
                    <p class="mb-0 mt-2"><strong>When disabled:</strong> New operations are <strong>approved automatically</strong> and immediately available for use.</p>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('fleet.approval-settings.store') }}" method="POST">
                    @csrf
                            ...
                            <div class="card border">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <small class="text-muted">Require approval for all fleet operations</small>
                                    </div>
                            ...
                            <div class="card border">
                                ...
                                <div class="card-body" id="approval_levels_config">
                                    <div class="alert alert-primary mb-4">
                                        ...
                                        <strong>How it works:</strong> Set amount thresholds and select approvers for each level. Operations above the threshold will require approval at that level.
                                    </div>
                                        ...
                                        <div class="approval-level-config mb-4 p-3 border rounded" id="level_{{ $level }}_config"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <small class="text-muted">Operations above this amount need this level approval</small>
                                                </div>

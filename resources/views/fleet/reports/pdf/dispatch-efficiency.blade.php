...
<head>
    ...
    <title>Dispatch Efficiency Report</title>
    <style>
        body {
...
<body>
    <div class="header">
        <div class="header-content">
            ...
            <div class="title-section">
                <h1>Dispatch Efficiency Report</h1>
                @if($company)
    ...
    @if($efficiencyData->count() > 0)
        ...
        <div class="summary-box">
            <div class="summary-item">
                <div class="summary-label">On-Time Trips</div>
                <div class="summary-value" style="color: #28a745;">{{ $onTimeCount }}</div>
            </div>
            <div class="summary-item">
                <div class="summary-label">Delayed Trips</div>
                <div class="summary-value" style="color: #dc3545;">{{ $delayedCount }}</div>
            </div>
            <div class="summary-item">
                <div class="summary-label">On-Time Rate</div>
                <div class="summary-value">{{ number_format($onTimeRate, 2) }}%</div>
            </div>
        </div>
        ...
        <table class="data-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 8%;" class="text-center">Delay (mins)</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <span class="badge {{ $data['on_time'] ? 'badge-success' : 'badge-danger' }}">
    ...
    @else
        <div class="no-data">
            ...
            <p>No dispatch efficiency data found for the selected criteria.</p>
        </div>
    @endif
    ...
    <div class="footer">
        ...
        <p style="font-size: 10px; margin-top: 5px;">Dispatch efficiency is calculated based on planned vs actual start times.</p>
    </div>
</body>
</html>

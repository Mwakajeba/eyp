...
<head>
    ...
    <title>Driver Outstanding Report</title>
    <style>
        body {
...
<body>
    <div class="header">
        <div class="header-content">
            ...
            <div class="title-section">
                <h1>Driver Outstanding Report</h1>
                @if($company)
        ...
        <table class="data-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 20%;" class="text-center">Outstanding Invoices</th>
                    <th style="width: 30%;" class="number">Total Outstanding</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td class="number"><strong>{{ number_format($data['total_outstanding'], 2) }}</strong></td>
                </tr>
                @endforeach
            </tbody>
            <tfoot>
                <tr>
                    ...
                    <td class="text-center" style="font-weight: bold;">{{ $outstandingData->sum('invoice_count') }}</td>
    ...
    <div class="footer">
        ...
        <p style="font-size: 10px; margin-top: 5px;">Outstanding amounts are calculated from unpaid invoices.</p>
    </div>
</body>
</html>

        ...
        <table class="data-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 11%;" class="number">Total Amount</th>
                    <th style="width: 11%;" class="number">Paid Amount</th>
                    <th style="width: 11%;" class="number">Balance Due</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ ucfirst(str_replace('_', ' ', $invoice->status ?? 'N/A')) }}</td>
                </tr>
                @endforeach
            </tbody>
            <tfoot>

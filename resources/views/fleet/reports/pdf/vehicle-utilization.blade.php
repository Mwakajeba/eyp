...
<body>
        ...
        <table class="data-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 12%;" class="text-center">Active Days</th>
                    <th style="width: 12%;" class="text-center">Total Days</th>
                    <th style="width: 15%;" class="text-center">Utilization Rate</th>
                    <th style="width: 14%;" class="number">Distance (km)</th>
                </tr>
            </thead>
            <tbody>
                @foreach($utilizationData as $data)
                @php
                    $badgeColor = $data['utilization_rate'] >= 75 ? 'badge-success' : ($data['utilization_rate'] >= 50 ? 'badge-warning' : 'badge-danger');
                @endphp
                <tr>
                    ...
                    <td class="text-center">
                        <span class="badge {{ $badgeColor }}">{{ number_format($data['utilization_rate'], 2) }}%</span>
                    </td>
    ...
    @else
        <div class="no-data">
            ...
            <p>No vehicle utilization data found for the selected criteria.</p>
        </div>
    @endif
    ...
    <div class="footer">
        ...
        <p style="font-size: 10px; margin-top: 5px;">Vehicle utilization is calculated based on active days vs total days in the period.</p>
    </div>
</body>
</html>

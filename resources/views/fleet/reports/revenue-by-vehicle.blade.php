...
@section('title', 'Revenue by Vehicle Report')
...
<div class="page-wrapper">
    <div class="page-content">
        <x-breadcrumbs-with-icons :links="[
            ...
            ['label' => 'Revenue by Vehicle Report', 'url' => '#', 'icon' => 'bx bx-car']
        ]" />

        <h6 class="mb-0 text-uppercase">REVENUE BY VEHICLE REPORT</h6>
        <hr />

        <!-- Filters -->
        <div class="card">
            <div class="card-body">
                <form method="GET" action="{{ route('fleet.reports.revenue-by-vehicle') }}" class="row g-3">
                    <div class="col-md-4">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-end gap-2">
                    <form method="POST" action="{{ route('fleet.reports.revenue-by-vehicle.export-excel') }}" style="display: inline;">
                        @csrf
                    ...
                    <form method="POST" action="{{ route('fleet.reports.revenue-by-vehicle.export-pdf') }}" style="display: inline;">
                        @csrf
                        <input type="hidden" name="date_from" value="{{ request('date_from') }}">
                        <input type="hidden" name="date_to" value="{{ request('date_to') }}">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card border-success">
                    <div class="card-body text-center">
                        <h6 class="text-muted">Vehicles with Revenue</h6>
            ...
            <div class="col-md-4">
                <div class="card border-info">
                    <div class="card-body text-center">
                        <h6 class="text-muted">Average Revenue per Vehicle</h6>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="text-center">No revenue data found for the selected criteria.</td>
                                </tr>
                            @endforelse
                        </tbody>
                        <tfoot>

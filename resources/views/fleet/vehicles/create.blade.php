...
@section('title', 'Add New Vehicle - Fleet Management')
...
<div class="page-wrapper">
    <div class="page-content">
        <x-breadcrumbs-with-icons :links="[
            ...
            ['label' => 'Add New Vehicle', 'url' => '#', 'icon' => 'bx bx-plus']
        ]" />

        <div class="card">
            <div class="card-header bg-primary text-white">
                <h6 class="mb-0"><i class="bx bx-plus me-2"></i>Add Vehicle</h6>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('fleet.vehicles.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input name="name" class="form-control" value="{{ old('name') }}" required placeholder="e.g., Toyota Hilux 2023">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input name="model" class="form-control" value="{{ old('model') }}" placeholder="Hilux">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input name="manufacturer" class="form-control" value="{{ old('manufacturer') }}" placeholder="Toyota">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" min="0" name="purchase_cost" class="form-control" value="{{ old('purchase_cost', 0) }}" placeholder="0.00">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input name="serial_number" class="form-control" value="{{ old('serial_number') }}" placeholder="VIN or Chassis Number">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input name="registration_number" class="form-control" value="{{ old('registration_number') }}" placeholder="T 123 ABC" required>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" min="0" name="capacity_volume" class="form-control" value="{{ old('capacity_volume') }}" placeholder="0.15">
                    ...
                    <div class="d-flex gap-2 justify-content-end">
                        <a href="{{ route('fleet.vehicles.index') }}" class="btn btn-outline-secondary"><i class="bx bx-arrow-back me-1"></i>Back to Vehicles</a>
                        <button type="submit" class="btn btn-primary"><i class="bx bx-check me-1"></i>Save Vehicle</button>
                    </div>
                </form>
            </div>
        </div>

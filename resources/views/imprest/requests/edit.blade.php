                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="department_id" id="department_id" class="form-select @error('department_id') is-invalid @enderror" required>
                                ...
                                <option value="{{ $department->id }}" {{ old('department_id', $imprestRequest->department_id) == $department->id ? 'selected' : '' }}>
                                    {{ $department->name }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="project_id" id="project_id" class="form-select @error('project_id') is-invalid @enderror">
                                ...
                                <option value="{{ $project->id }}" {{ old('project_id', $imprestRequest->project_id) == $project->id ? 'selected' : '' }}>
